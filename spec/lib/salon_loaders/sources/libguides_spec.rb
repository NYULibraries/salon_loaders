...
describe SalonLoaders::Sources::Libguides do
  ...
  describe "#get_permalinks" do
    ...
    let(:api_asset1){ instance_double LibGuides::API::Az::Asset, id: '1', url: 'https://arch.library.nyu.edu/databases/proxy/NYU00685', internal_note: "ONLY KARMS | NYU00685 | PROXY_YES | http://link.springer.com/search?showAll=false" }
    let(:api_asset2){ instance_double LibGuides::API::Az::Asset, id: '2', url: 'https://persistent.library.nyu.edu/arch/SLNID1', internal_note: "ONLY KARMS | NYU05226 | PROXY_NO | http://streaming.videatives.com/autologin/#/123" }
    let(:api_asset3){ instance_double LibGuides::API::Az::Asset, id: '3', url: 'https://persistent.library.nyu.edu/arch/SLNID2', internal_note: "ONLY KARMS | NULL | PROXY_YES | http://streaming.videatives.com/autologin/#/123" }
    let(:api_asset4){ instance_double LibGuides::API::Az::Asset, id: '4', url: 'https://persistent.library.nyu.edu/arch/SLNID3', internal_note: "" }
    before do
